            ...
            <div class="single-section">
                <div class="single-tools-breadcrumb">
                    <div class="single-bread-crumb">
                        ...
                        <a href="{{ route('videogallery')  }}"><span>ویدیو</span></a>
                        <a><span>{{ $video->title }}</span></a>
                    ...
                    <div class="single-tools">
                        ...
                        <p>
                            <span>{{ jalaliDate($video->create_at, 'd M Y') }}</span>
                            <span>-</span>
                            <span>{{ jalaliDate($video->create_at, 'H:i') }}</span>
                        </p>
                    </div>
                </div>
                ...
                <div class="share-post-buttons-link">
                    <div class="share-post-buttons">
                        <button class="share-twitter">
                            <a href="https://twitter.com/intent/tweet?text=Awesome%20Blog!&url={{ route('videogallery.show', $video) }}">
                        ...
                        <button class="share-telegram">
                            <a href="https://t.me/share/url?url={{ route('videogallery.show', $video) }}&text=Awesome%20blog!">
                        ...
                        <button class="share-whatsapp">
                            <a href="https://wa.me/?text=Awesome%20Blog!%5Cn%20{{ route('videogallery.show', $video) }}">
                        ...
                        <button class="share-facebook">
                            <a href="https://www.facebook.com/sharer/sharer.php?u={{ route('videogallery.show', $video) }}&quote=Awesome%20Blog!">
