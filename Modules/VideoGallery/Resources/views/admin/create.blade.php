...
@section('title')
    ساخت گالری ویدیو | داشبورد مدیریت
@endsection
@section('content')
    <!-- breadcrumb -->
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">ساخت گالری ویدیو</li>
        </ol>
    </nav>
    <!-- breadcrumb -->
            ...
            <div class="pb-0 mb-2">
                <div class="d-flex justify-content-between">
                    <div class="d-flex gap-2">
                        ...
                        <p class="tx-12 tx-gray-500 mb-2">ساخت گالری ویدیو.
                        ...
                        <div class="card-body pt-0">
                            <div>
                                ...
                                <div class="form-group mb-4">
                                    <input type="file" name="video" class="dropify" data-height="200">
                                ...
                                <div class="form-group mb-4">
                                    <label for="body" class="@error('description') tx-danger @enderror">متن
                                        <span class="tx-danger">*</span></label>
                                    <textarea type="text" class="form-control form-control-sm @error('description') border border-danger @enderror" name="description" id="editor">{{ old('description') }}</textarea>
