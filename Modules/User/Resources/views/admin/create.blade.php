...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">ثبت کاربر</li>
        </ol>
    </nav>
    <!-- breadcrumb -->
            ...
            <div class="pb-0 mb-2">
                <div class="d-flex justify-content-between">
                    <div class="d-flex gap-2">
                        <h4 class="card-fullname mg-b-0">کاربران</h4>
                        <p class="tx-12 tx-gray-500 mb-2">ثبت کاربر.
                            ...
                            <div class="card-body pt-0">
                                <div>
                                    ...
                                    <div class="form-group mb-4">
                                        <label class="form-label @error('name') tx-danger @enderror">نام کاربری:
                                    ...
                                    <div class="form-group mb-4">
                                        <label class="form-label @error('first_name') tx-danger @enderror">نام:
                                            <span class="tx-danger">* <small class="tx-primary">درصورت خالی بودن نام کاربری، الزامی است</small></span></label>
                                        <input type="text" name="first_name" class="form-control @error('first_name') border-danger @enderror" value="{{ old('first_name') }}">
                                        @error('first_name')
                                    ...
                                    <div class="form-group mb-4">
                                        <label class="form-label @error('last_name') tx-danger @enderror">نام خانوادگی:
                                            <span class="tx-danger">* <small class="tx-primary">درصورت خالی بودن نام کاربری، الزامی است</small></span></label>
                                        <input type="text" name="last_name" class="form-control @error('last_name') border-danger @enderror" value="{{ old('last_name') }}">
                                        @error('last_name')
                                        <small class="tx-danger">{{ $message }}</small> @enderror
                                    </div>
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <input type="email" name="email" class="form-control @error('email') border-danger @enderror" value="{{ old('email') }}">
